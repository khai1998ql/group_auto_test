...
def init_browser() -> Iterator[WebDriver]:
    ...
    path_chrome = '/home/khains/Documents/group_auto_test/files/chrome-linux64/chrome'
    path_driver = '/home/khains/Documents/group_auto_test/files/chromedriver-linux64/chromedriver'
